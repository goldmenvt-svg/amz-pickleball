...
| TD-06 | 🟡 Một phần | Owner đã chấp nhận TD-06A và thiết kế TD-06B; runtime/migration/export nguyên tử chưa triển khai |
...
- **TD-06B:** kế hoạch triển khai theo pha, migration idempotent, export một commit, backup/rollback và handoff TD-09 tại `docs/design/DESIGN-td-06b-runtime-migration-plan.md`; Owner chấp nhận thiết kế ngày 2026-08-05, chưa cấp quyền triển khai.
